...
public class CubicInterpolator extends EaseInterpolator implements Interpolator {

    public CubicInterpolator(float duration, float begingValue, float endValue, InterpolatorType interpolatorType) {
    ...
    public CubicInterpolator(float duration, InterpolatorType interpolatorType) {
        this.duration = duration;
        this.mInterpolatorType = interpolatorType;
    }
